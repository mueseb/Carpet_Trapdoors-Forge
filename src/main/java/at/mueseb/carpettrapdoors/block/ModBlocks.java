...
import at.mueseb.carpettrapdoors.CarpetTrapdoorsMain;
...
public class ModBlocks {
    ...
    public static void registerWoodenTrapdoors()
    {
        for (String color: colors) {
            registerBlock(color+"_carpet_trapdoor", () -> new CarpetTrapdoor(BlockBehaviour.Properties.of().strength(0.1f, 0.1f).sound(SoundType.WOOL), BlockSetType.OAK));
        }
    }
    public static void registerIronTrapdoors()
    {
        for (String color: colors) {
            registerBlock(color+"_carpet_iron_trapdoor", () -> new CarpetTrapdoor(BlockBehaviour.Properties.of().strength(0.1f, 0.1f).sound(SoundType.WOOL), BlockSetType.IRON));
        }
    }
