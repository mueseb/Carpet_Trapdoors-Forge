...
public class ModBlocks {
    ...
    public static void registerWoodenTrapdoors()
    {
        for (String color: colors) {
            registerBlock(color+"_carpet_trapdoor", () -> new CarpetTrapdoor(AbstractBlock.Properties.of(Material.WOOL).strength(0.1f, 0.1f).sound(SoundType.WOOL)));
        }
    }
    public static void registerIronTrapdoors()
    {
        for (String color: colors) {
            registerBlock(color+"_carpet_iron_trapdoor", () -> new CarpetTrapdoor(AbstractBlock.Properties.of(Material.METAL).strength(0.1f, 0.1f).sound(SoundType.WOOL)));
        }
    }
